/**
 * Deploy GPACT contracts to bc1 (root chain).
 *
 * Run:
 *   npx hardhat --config hardhat.gpact-bc1.config.ts \
 *               --network besu run scripts/gpact/deploy-bc1.ts
 *
 * Deploys:
 *   GPACTEventSignerRegistry, GPACTCrosschainControl, GPACTTravelRoot
 *
