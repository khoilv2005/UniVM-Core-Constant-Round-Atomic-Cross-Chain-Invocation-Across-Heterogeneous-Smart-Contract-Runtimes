...
contract RelayerManager is Ownable {
    ...
    function rewardRelayer(address relayer, string calldata reason) external onlyBridgingContract {
        require(relayers[relayer].registered, "Not registered");
    ...
    function penalizeRelayer(address relayer, string calldata reason) external onlyBridgingContract {
        require(relayers[relayer].registered, "Not registered");
